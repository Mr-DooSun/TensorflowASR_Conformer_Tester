...
class ASRDataset(BaseDataset):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super().__init__(
            augmentations=augmentations, cache=cache,
            shuffle=shuffle, stage=stage, buffer_size=buffer_size,
...
class ASRTFRecordDataset(ASRDataset):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            augmentations=augmentations, cache=cache, shuffle=shuffle, buffer_size=buffer_size,
            drop_remainder=drop_remainder, use_tf=use_tf, indefinite=indefinite
        )
        if not self.stage:
...
class ASRSliceDataset(ASRDataset):
    ...
    def create(self, batch_size: int, path: str):
